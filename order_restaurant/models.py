...
class Order(models.Model):
    ...
    house = models.CharField(blank=True, max_length=3, default='Уточнити', verbose_name='Будинок')
    entrance = models.CharField(blank=True, max_length=2, default='Уточнити', verbose_name="Під'їзд")
    intercom = models.CharField(blank=True, max_length=4, default='Уточнити', verbose_name="Домофон")
