...
class Order(models.Model):
    ...
    total_price = models.PositiveIntegerField(default=0, verbose_name='Цена заказа')
...
class DishInOrder(models.Model):
    ...
    price_per_item = models.PositiveIntegerField(default=0, verbose_name='Цена за ед.')
    total_price = models.PositiveIntegerField(default=0, verbose_name='Всего') #price*number
    created_at = models.DateTimeField(auto_now_add=True, null=True, verbose_name='Создано')
    updated_at = models.DateTimeField(auto_now=True, null=True, verbose_name='Обновлено')
