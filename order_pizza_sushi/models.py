...
class Order(models.Model):
    ...
    house = models.CharField(blank=True, max_length=8, default='Уточнити', verbose_name='Будинок')
    entrance = models.CharField(blank=True, max_length=8, default='Уточнити', verbose_name="Під'їзд")
    intercom = models.CharField(blank=True, max_length=8, default='Уточнити', verbose_name="Домофон")
    do_not_call = models.BooleanField(blank=True, verbose_name='Не дзвонити мені')
    time_of_delivery = models.TimeField(choices=CHOICES_FOR_TIME, blank=True, default='Як можна ранiше', verbose_name='Час доставки')
